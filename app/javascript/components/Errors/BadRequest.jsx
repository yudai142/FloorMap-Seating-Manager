  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        <div className="mb-8">
          <div className="text-8xl font-bold text-slate-200 mb-4">400</div>
          <h1 className="text-3xl font-bold text-slate-800 mb-2">不正なリクエスト</h1>
          <p className="text-slate-600">
            申し訳ございません。リクエストに問題があります。もう一度お試しください。
          </p>
        </div>
